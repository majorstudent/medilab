...
<!--          </li>-->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container">
      ...
      <h2>We offer high quality and affordable medical services.</h2>
        ...
        <div class="row">
          <div class="col-lg-4 d-flex align-items-stretch">
            <div class="content">
              ...
              <p>
                We have highly experienced doctors, having graduated from the best of medical universities.
              </p>
    ...
    <section id="appointment" class="appointment section-bg">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>You can make an appointment with us by <strong>filling the form</strong> below as required.</p>
        </div>
